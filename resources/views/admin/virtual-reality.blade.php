...
<body class="g-sidenav-show  bg-gray-100 virtual-reality">
  ...
  <div class="border-radius-xl mt-4 mx-4 position-relative" style="background-image: url('../admin/assets/img/vr-bg.jpg') ; background-size: cover;">
          ...
          <div class="row pt-10">
            ...
            <div class="col-lg-8 col-md-11">
              <div class="d-flex">
                ...
                <div class="ms-auto">
                  <img class="w-50 float-end mt-md-n5" src="../admin/assets/img/small-logos/icon-sun-cloud.png" alt="image sun">
                </div>
              </div>
              <div class="row mt-4">
