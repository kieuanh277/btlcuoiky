                ...
                <div class="card p-3">
                    <form method="post" action="{{route('sites.update',[$site])}}" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="location_id" id="location_id">
                                    @foreach($locations as $location)
                                        <option value="{{ $location->id }}" {{ ($site->location_id == $location->id) ? 'selected' : '' }}>
                        ...
                        <div class="form-group row border-bottom pb-4">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="description" id="description" cols="30" rows="7">{{ old('description',$site->description) }}</textarea>
                            </div>
