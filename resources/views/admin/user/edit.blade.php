                ...
                <div class="card p-3">
                    <form method="post" action="{{route('users.update',[$user])}}">
                        ...
                        <div class="form-group row border-bottom pb-4">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="email" value="{{ old('email',$user->email) }}" id="title" readonly>
                            </div>
                            @if ($errors->has('email'))
                        ...
                        <div class="form-group row border-bottom pb-4">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="fullName" value="{{ old('fullName',$user->fullName) }}" id="title" >
                            </div>
                        ...
                        <div class="form-group row border-bottom pb-4">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="phoneNumber" value="{{ old('phoneNumber',$user->phoneNumber) }}" id="title" >
                            </div>
