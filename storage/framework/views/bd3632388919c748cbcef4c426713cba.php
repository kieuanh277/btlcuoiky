            ...
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
                <div class="col-md-9 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                    ...
                    <div class="block-17 my-4">
                        <form action="<?php echo e(route('searchTour')); ?>" method="get" class="d-block d-flex">
                            <?php echo csrf_field(); ?>
                        ...
                        <?php $__currentLoopData = $sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item">
                                <div class="destination">
                                    ...
                                    <a href="<?php echo e(Storage::url($site->image)); ?>" class="img d-flex justify-content-center align-items-center" style="background-image: url(<?php echo e(Storage::url($site->image)); ?>);">
                                        <div class="icon d-flex justify-content-center align-items-center">
                                            <span class="icon-search2"></span>
                                        </div>
                                    </a>
                                    <div class="text p-3">
                                        <h3><a href="<?php echo e(route('tour.getTour',[$site])); ?>"><?php echo e($site->siteName); ?></a></h3>
                                        <span class="listing"><?php echo e($site->tour->count()); ?> Tour Tất Cả</span>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-sm col-md-6 col-lg ftco-animate">
                            <div class="destination">
                                ...
                                <div class="text p-3">
                                    ...
                                    <span style="color:red; font-size:20px;" class="price"><?php echo e($detail->childrenPrice); ?> - <?php echo e($detail->adultPrice); ?> VNĐ</span>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Công việc\WebBanTourDuLich-1\resources\views/index.blade.php ENDPATH**/ ?>