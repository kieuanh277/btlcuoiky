                        ...
                        <form method="POST" action="" role="form">
                            ...
                            <div>
                                <p class="text-sm mt-3 mb-0">Đã có tài khoản?
                                    <a href="<?php echo e(route('auth.signin')); ?>" class="text-dark font-weight-bolder">Đăng
                                        Nhập</a>
                                </p>
                                <p class="text-sm mt-3 mb-0">Chưa có tài khoản?
                                    <a href="<?php echo e(route('auth.signup')); ?>" class="text-dark font-weight-bolder">Tạo tài
                                        khoản
                                    </a>
                                </p>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\btlcuoiky\resources\views/auth/forgot.blade.php ENDPATH**/ ?>