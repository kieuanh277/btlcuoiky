    ...
    <div class="container">
        <div class="row gutters">
                    ...
                    <div class="card-body">
                        <div class="account-settings">
                            <div class="user-profile">
                                ...
                                <h5 class="user-name"><?php echo e($user->fullName); ?></h5>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <form method="POST" class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12"
                action="<?php echo e(route('account.update', ['user' => $user->id])); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="fullName" name="fullName"
                                        value="<?php echo e($user->fullName); ?>" placeholder="Nhập họ tên">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                        value="<?php echo e($user->email); ?>" placeholder="Nhập email">
...
<?php /**PATH C:\xampp\htdocs\btlcuoiky\resources\views/account/account-detail.blade.php ENDPATH**/ ?>