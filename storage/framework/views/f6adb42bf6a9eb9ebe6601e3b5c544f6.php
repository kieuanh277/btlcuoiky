                    ...
                    <div class="card-body">
                        <form method="POST" action="" role="form">
                            ...
                            <p class="text-sm mt-3 mb-0">Đã có tài khoản? <a
                                    href="<?php echo e(route('auth.signin')); ?>" class="text-dark font-weight-bolder">Đăng Nhập</a>
                            </p>
                        </form>
                    </div>
                </div>
...
<?php /**PATH C:\Công việc\WebBanTourDuLich-1\resources\views/auth/sign-up.blade.php ENDPATH**/ ?>